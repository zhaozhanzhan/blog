...
class FrontCommentSub extends Model
{
    ...
    protected $fillable = ["msg_id", "article_id", "qq", "name", "email", "avatar", "content", "thumb_num", "master", "be_qq", "be_name", "be_email", "be_avatar", "be_master", "created_at"];
...
//        return ["code" => Code::$SUCCESS, "data" => $msg];
    ...
    {
        $isMsg = FrontCommentSub::where(["id" => $params["subId"]])->first();
